...
plot_density(bkgpath, comppath='mXist_airn_500nt_k4_seekr_rscore_qlist_manxist.csv', 
             compname='mXist vs airn')

plot_density(bkgpath, comppath='mXist_kcnq1ot1_500nt_k4_seekr_rscore_qlist_manxist.csv', 
             compname='mXist vs kcnq1ot1')

plot_density(bkgpath, comppath='airn_kcnq1ot1_500nt_k4_seekr_rscore_qlist_manxist.csv', 
             compname='airn vs kcnq1ot1')